 ...
 * @see SimpleMessageMulticaster
 * @since 1.0
 */
public interface MessageMulticaster {
     ...
     */
    void addApplicationListener(MessageSubscriber<?> listener);
     ...
     */
    void removeApplicationListener(MessageSubscriber<?> listener);
     ...
     */
    void multicastEvent(Message event);
