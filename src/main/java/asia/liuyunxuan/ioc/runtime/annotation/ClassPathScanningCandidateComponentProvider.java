...
public class ClassPathScanningCandidateComponentProvider {
     ...
     */
    public Set<ComponentDefinition> findCandidateComponents(String basePackage) {
        Set<ComponentDefinition> candidates = new LinkedHashSet<>();
        try {
     ...
     */
    private void findClassesInDirectory(File directory, String packageName, Set<ComponentDefinition> candidates) {
                ...
                if (file.isDirectory()) {
                    ...
                    try {
                        ...
                        if (clazz.isAnnotationPresent(Injectable.class)) {
                            candidates.add(new ComponentDefinition(clazz));
                        }
