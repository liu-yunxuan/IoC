 ...
 * @since 1.0
 */
public class ClassPathXmlContext extends AbstractXmlContext {
     ...
     * @throws ComponentException 如果加载或解析配置文件时发生错误
     */
    public ClassPathXmlContext(String configLocations) throws ComponentException {
