...
public interface InstantiationAwareBeanPostProcessor extends BeanPostProcessor {
     ...
     * @throws ComponentException 如果发生错误
     */
    Object postProcessBeforeInstantiation(Class<?> beanClass, String beanName) throws ComponentException;
     ...
     * @throws ComponentException 如果发生错误
     */
    boolean postProcessAfterInstantiation(Object bean, String beanName) throws ComponentException;
     ...
     * @throws ComponentException 如果发生错误
     */
    PropertyValues postProcessPropertyValues(PropertyValues pvs, Object bean, String beanName) throws ComponentException;
